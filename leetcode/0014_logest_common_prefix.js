...
// i   j   current  i === strs[j].length   strs[j][i] !== current   strs[0].substring(0, i)
// 0   1      f      0 === 4 F               f !== f F                      -
// 0   2      f      0 === 6 F               f !== f F                      -
// 1   1      l      1 === 4 F               l !== l F                      -
// 1   2      l      1 === 6 F               l !== l F                      -
// 2   1      o      2 === 4 F               o !== o F                      -
// 2   2      o      2 === 6 F               i !== o T             "flower".substring(0, 2) fl
...
// 1. We iterates through the strings, finding at each iteration the longest common prefix.
//     1.1. We ind the longest common prefix of strs[0] with strs[1] with strs[2] and so on.
